...
const EconomicsFinanceAcademic = () => {
  return (
    <>
    <motion.div
            ...
            <div className="container">
                <div className="row row-cols-2">
                    <div className="col-6 text-size col-md-7 py-4">
                        <h3 className='text-light'>Economics & Finance– Academic Writing </h3>
                        <h4 className="text-light fs-5"> PhD, Mster's & Authors/Publishers </h4>
                        <p className="text-light fs-5"> The US & UK technical writers at PhD Assistance impart knowledge to students and researchers and build confidence in them to make their economics & finance academic writing a huge success. </p>
...
export default EconomicsFinanceAcademic