            ...
            <div className="container">
                <div className="row row-cols-2">
                    <div className="col-6 text-size col-md-7 py-4">
                        <h3 className='text-light'> Biological & Life Science– Academic Writing </h3>
                        <h4 className="text-light fs-5"> PhD, Master’s & Authors / Publishers </h4>
    ...
    >
        <div className="bg-dark pt-5 pb-4">
            <div className="container text-center">
                <h2 className="text-light"> Biological & Life Science (Thesis), Assignments, Manuscript Writing & Editing Services </h2>
