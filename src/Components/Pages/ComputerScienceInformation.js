            ...
            <div className="container">
                <div className="row row-cols-2">
                    <div className="col-6 text-size col-md-7 py-4">
                        <h3 className='text-light'> Computer Science & Information Technology– Academic Writing </h3>
                        <p className="text-light fs-5"> PhD, Master’s & Authors / Publishers </p>
                        <p className="text-light fs-5"> The US & UK writers at PhD Assistance aim to impart knowledge in students and build their confidence to submit their engineering and information technology related research paper successfully. </p>
    ...
    >
        <div className="bg-dark pt-5 pb-4">
            <div className="container text-center">
                <h2 className="text-light"> Computer Science & Information Technology (Thesis), Assignments, Manuscript Writing & Editing Services </h2>
    ...
    >
        <div className="img-bg2">
            <div className="row">
                ...
                <div className="text-size col-md-5 bg-secondary container me-5">
