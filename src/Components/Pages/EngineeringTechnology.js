            ...
            <div className="container">
                <div className="row row-cols-2">
                    <div className="col-6 text-size col-md-7 py-4">
                        <h3 className='text-light'> Engineering & Technology– Academic Writing </h3>
    ...
    >
        <div className="bg-dark pt-5 pb-4">
            <div className="container text-center">
                <h2 className="text-light"> Engineering & Technology Assignments, Manuscript Writing & Editing Services. </h2>
