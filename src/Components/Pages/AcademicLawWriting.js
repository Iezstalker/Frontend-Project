                    ...
                    <div className="container">
                        <div className="row row-cols-1 row-cols-md-3 g-2">
                            <div className="col-6 text-size col-md-7 py-4">
                                <h3 className='text-light'> Law – Academic Writing PhD, Master’s & Authors / Publishers
                                </h3>
                                <p className="text-light fs-5">The US & UK writers at Ph.D. Assistance aim at inculcating knowledge within students and build a great confidence to submit their dissertation successfully.</p>
