            ...
            <div className="container">
                <div className="row row-cols-2">
                    <div className="col-6 text-size col-md-7 py-4">
                        <h3 className='text-light'> Business & Management Studies– Academic Writing </h3>
                        <p className="text-light fs-5"> The US & UK business writers at PhD Assistance aim to impart knowledge in students and build their confidence to submit their business & management including international business, leadership and SCM writing successfully.</p>
    ...
    >
        <div className="bg-dark pt-5 pb-4">
            <div className="container text-center">
                <h2 className="text-light"> Business & Management Dissertation (Thesis), Assignments, Manuscript Writing & Editing Services </h2>
