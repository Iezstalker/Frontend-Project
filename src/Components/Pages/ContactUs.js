      ...
      <div className="container d-flex justify-content-center my-5">
        <form className="w-50 needs-validation" noValidate>
          ...
          <div className="mb-3">
            ...
            <input type='tel' className="form-control" id="validationCustom02" placeholder='Mobile Number with country code' required />
            <div className="invalid-feedback">
          ...
          <div className="mb-3">
            <label htmlFor="validationCustom04" className="form-label"> Type of Order </label>
            <select className="form-select" id="validationCustom04" required>
              ...
              <option value="12"> Publishing Support </option>
              <option value="13"> Introduction </option>
              <option value="14"> Data Analysis & Interpretation </option>
              <option value="15"> Phd Topic Selection </option>
              <option value="16"> Problem Identification </option>
              <option value="17"> Phd Research proposal </option>
              <option value="18"> Phd Thesis(Full/Part) writing/editing </option>
              <option value="19"> Biostatistics </option>
          ...
          <div className="mb-3">
            <label htmlFor="validationCustom06" className="form-label"> Requirements </label>
            <textarea className="form-control" id="validationCustom06" rows="3" required></textarea>
            <div className="invalid-feedback">
              Please enter your response.
            </div>
          </div>
          <div className="text-center">
            <button className="btn btn-outline-warning button" type="submit">Submit form</button>
          </div>
        </form>
      </div>
    </motion.div>
