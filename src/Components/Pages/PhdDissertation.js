                    ...
                    <div className="container">
                        <div className="row row-cols-1 row-cols-md-3 g-2">
                            <div className="col-6 text-size col-md-7 py-4">
                                <h3 className='text-light'> Are you finding assistance (or) guidance to translate your Ph.D. Research idea into writing?
                                </h3>
                                <p className="text-light fs-5">Are you afraid to put creative ideas or intellectual thoughts in writing for fear of rejections by others?</p>
            ...
            >
                <div className="img-bg2">
                    <div className="row row-cols-1 row-cols-md-3 g-2">
                        ...
                        <div className="text-size col-md-5">
