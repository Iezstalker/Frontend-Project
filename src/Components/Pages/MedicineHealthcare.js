        ...
        <div className="container">
          <div className="row row-cols-1 row-cols-md-3 g-2">
            <div className="col-6 text-size col-md-7 py-4">
              <h3 className='text-light'> Medicine & Health Science– Academic Writing </h3>
              <h4 className="text-light fs-5"> PhD, Master’s & Authors / Publishers </h4>
              <p className="text-light fs-5"> The US& UK medical writers at PhD Assistance aim to impart knowledge in students and build their confidence to submit their medicine academic writing successfully. </p>
    ...
    >
      <div className="bg-dark pt-5 pb-4">
        <div className="container text-center">
          <h2 className="text-light"> Medicine & Allied Health Dissertation (Thesis), Assignments, Manuscript Writing & Editing Services </h2>
